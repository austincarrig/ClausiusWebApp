...
const TOP_LEFT_TS_DIAGRAM_T: f32 = 699.0 + C_TO_K;
const TOP_LEFT_TS_DIAGRAM_D: f32 = 250.0;

const TOP_RIGHT_TS_DIAGRAM_T: f32 = 700.0 + C_TO_K;
const TOP_RIGHT_TS_DIAGRAM_D: f32 = 0.24143509017;

const BOTTOM_RIGHT_TS_DIAGRAM_T: f32 = 1.0 + C_TO_K;
...
const SUPERHEATED_POINT_2_T: f32 = 420.38 + C_TO_K;
const SUPERHEATED_POINT_2_D: f32 = 270.27027027;

const SUPERHEATED_POINT_3_T: f32 = 393.16 + C_TO_K;
const SUPERHEATED_POINT_3_D: f32 = 0.82155767334;

const SUPERHEATED_POINT_4_T: f32 = 334.99 + C_TO_K;
const SUPERHEATED_POINT_4_D: f32 = 27.7777777778;

const SUPERHEATED_POINT_5_T: f32 = 245.84 + C_TO_K;
const SUPERHEATED_POINT_5_D: f32 = 0.07614812332;

const SUPERHEATED_POINT_6_T: f32 = 160.46 + C_TO_K;
const SUPERHEATED_POINT_6_D: f32 = 2.75406224181;

const SUPERHEATED_POINT_7_T: f32 = 260.68 + C_TO_K;
const SUPERHEATED_POINT_7_D: f32 = 19.9600798403;

// Above Critical Point
const SUPERHEATED_POINT_8_T: f32 = 389.41 + C_TO_K;
